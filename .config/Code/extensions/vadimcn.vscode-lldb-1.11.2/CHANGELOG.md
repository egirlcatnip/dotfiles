...
## New
- Implemented [Excluded Callers](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#excluded-callers) feature, similar to the
  [one in Javascript debugger](https://code.visualstudio.com/updates/v1_64#_javascript-debugging).
- Added [create_webview()](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#webview) Python API, which allows scripts to create and manipulate VSCode Webviews.
...
- Added experimental `split` option to the [`consoleMode`](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#general) config setting.  In this mode the debug console
  will be used for evaluation of expressions and a separate terminal will be created for input of LLDB commands.

## Changed
- ["Simple" expressions](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#simple-expressions)" now use a proper parser, which should make syntax error messages less confusing.
...
- The `show_debug_info` [command](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#debugger-commands) has been renamed to `debug_info`, with sub-commands `list` and `show`.
...
- Added UI for [console mode](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#debug-console) switching.
...
- Added [`debug_info`](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#debugger-commands) LLDB command, that makes it easier to determine which modules have debug info available.
...
- Upon completing a request, the [RPC server](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#rpc-server) will now respond with a status message.
...
- Added [RPC server](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#rpc-server) for "external" launching.
...
## Other
- [Version 5.3](https://github.com/mozilla/rr/releases/tag/5.3.0) of Mozilla's [rr](https://rr-project.org/) has been released a few days ago.  It seems to work pretty well with CodeLLDB's [reverse debugging](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#reverse-debugging) support.
...
- The `.../command` [URL handler](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#starting-debug-session-outside-of-vscode) now supports setting debuggee environment variables.
...
- Added URL handler for [starting a debug session from outside of VSCode](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#starting-debug-session-outside-of-vscode).<br>
...
# 0.8.8
- Added [`postRunCommands`](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#launching).
- Bug fixes.
...
# 0.8.5
- Added support for [Cargo projects](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#cargo-support).
...
- Added `expressions` ∈ { `simple`, `python`, `native` } launch configuration property, which selects the default
  [expression evaluator type](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#expressions).
...
# 0.8.0
- Added [Parameterized Launch Configurations](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#parameterized-launch-configurations).
...
# 0.7.4
- It is now possible to set [default values for launch configurations](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#workspace-configuration) per-workspace.
...
# 0.3.3
- [Custom launch requests](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#custom-launch).
...
# 0.3.2
- Added pickProcess and pickMyProcess commands to be used with the **pid** parameter when [attaching](https://github.com/vadimcn/codelldb/blob/v1.11.2/README.md#attaching).
...
# 0.3.0
- [Variable visualizers for Rust](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#rust-language-support).
- New [expression evaluator](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#expressions).
- Bug fixes.
...
# 0.2.0
- Added [disassembly view](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#disassembly-view).
- Added [variable formatting](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#formatting).

# 0.1.3
- Added support for setting variable values (primitive types only).
- Added [regex breakpoints](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#regex-breakpoints).
