...
For full details please see [User's Manual](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md).<br>
...
via [remote debugging](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md#remote-debugging).

# More information
- [CodeLLDB User's Manual](https://github.com/vadimcn/codelldb/blob/v1.11.2/MANUAL.md) - how to use this extension.
...
![source](https://github.com/vadimcn/codelldb/raw/v1.11.2/images/plotting.png)
<br>
<br>
Rust debugging:<br>
![source](https://github.com/vadimcn/codelldb/raw/v1.11.2/images/source.png)
