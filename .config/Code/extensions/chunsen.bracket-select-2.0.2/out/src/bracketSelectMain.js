...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('bracket-select.select', function () {
        expandSelection(false);
    }), vscode.commands.registerCommand('bracket-select.undo-select', history.unDoSelect), vscode.commands.registerCommand('bracket-select.select-include', function () {
